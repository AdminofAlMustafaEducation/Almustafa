    ...
    <>
      <section className="relative bg-navy-deep text-primary-foreground py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="ornament text-xs uppercase tracking-[0.3em] text-gold">Our Story</p>
          ...
          <div className="gold-divider my-8 mx-auto w-32" />
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <p className="ornament text-xs uppercase tracking-[0.3em] text-gold font-semibold inline-block">The Beginning</p>
            <h2 className="mt-4 font-display text-4xl md:text-5xl text-navy font-bold leading-tight">A vision born in Islamabad, in 1998.</h2>
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed font-serif-elegant italic text-lg text-navy">
      ...
      <section className="bg-navy-deep text-primary-foreground py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="ornament text-xs uppercase tracking-[0.3em] text-gold font-semibold">What Drives Us</p>
            <h2 className="mt-4 font-display text-4xl md:text-5xl font-bold">Mission, Vision & Values</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={t} className="bg-navy rounded-2xl p-8 border border-gold/15 hover:border-gold/40 transition-colors">
                <div className="h-14 w-14 rounded-xl bg-gold-gradient flex items-center justify-center mb-5 shadow-gold">
                  <Icon className="h-7 w-7 text-navy-deep" />
                </div>
                <h3 className="font-display text-2xl text-gold font-bold mb-3">{t}</h3>
                <p className="text-primary-foreground/75 leading-relaxed">{d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="ornament text-xs uppercase tracking-[0.3em] text-gold font-semibold">Our Journey</p>
            <h2 className="mt-4 font-display text-4xl md:text-5xl text-navy font-bold">A timeline of trust</h2>
          </div>
            ...
            {[
              ...
              <div key={m.year} className={`relative flex md:items-center mb-10 ${i % 2 ? "md:flex-row-reverse" : ""}`}>
                ...
                <div className="ml-12 md:ml-0 md:w-1/2 md:px-8">
                  <div className="bg-card border border-border rounded-2xl p-6 hover:border-gold transition-colors shadow-card">
                    <div className="font-display text-3xl text-gold font-bold">{m.year}</div>
                    <h3 className="font-display text-xl text-navy font-bold mt-1">{m.t}</h3>
      ...
      <section className="bg-gold-gradient py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <Heart className="h-10 w-10 text-navy-deep mx-auto mb-4" />
          <h3 className="font-display text-3xl md:text-4xl text-navy-deep font-bold">
            Become part of our story.
          </h3>
          <p className="mt-3 text-navy-deep/80">Visit us at {academy.addressPrimary}</p>
          <Link to="/contact" className="mt-6 inline-flex items-center gap-2 bg-navy-deep text-gold font-semibold px-7 py-3.5 rounded-full hover:bg-navy transition-colors">
            Get in Touch
          </Link>
        </div>
      </section>
