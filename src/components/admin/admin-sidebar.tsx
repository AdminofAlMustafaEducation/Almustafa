...
export function AdminSidebar({ mobileOpen = false, onMobileClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex h-dvh w-64 flex-col border-r border-gray-800 bg-black text-white shadow-xl transition-transform duration-200 md:static md:z-auto md:h-full md:shrink-0 md:shadow-none",
