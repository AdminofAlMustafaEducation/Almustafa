...
const mockFaculty: Faculty[] = [
  {
    ...
    subject: "Mathematics",
    designation: "Director Academy",
    initials: "AA",
    photo_url: "/faculty/syed-ali-azeem-kazmi.jpg",
    campus: "main",
    is_active: true,
    sort_order: 1,
  ...
  },
  {
    ...
    designation: "Director Academy",
    initials: "AB",
    photo_url: "/faculty/syed-ali-abbas-kazmi.jpg",
    campus: "main",
    is_active: true,
    sort_order: 2,
    created_at: "2024-01-01T00:00:00Z",
  ...
  {
    id: "3",
    name: "Syed Sajid Kazmi",
    subject: "Biology",
    designation: "V.P ICB G-6/3",
    initials: "SK",
    campus: "second",
    is_active: true,
    sort_order: 3,
  ...
  },
  {
    ...
    subject: "Coordinator",
    designation: "IMCB G-10/4",
    initials: "MZ",
    photo_url: "/faculty/ch-muhammad-zareef.jpg",
    campus: "main",
    is_active: true,
    sort_order: 4,
    created_at: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    name: "Nabeel Kanwar",
    subject: "Physics",
    designation: "Lecturer IMCB H-9",
    initials: "NK",
    photo_url: "/faculty/nabeel-kanwar.jpg",
    campus: "main",
    is_active: true,
    sort_order: 5,
    created_at: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    designation: "Bahria College",
    initials: "ZH",
    photo_url: "/faculty/zahid-abbas-hiraj.jpg",
    campus: "second",
    is_active: true,
    sort_order: 6,
    created_at: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    subject: "Chemistry",
    designation: "Lecturer IMCB G-11/1",
    initials: "AA",
    photo_url: "/faculty/syed-assad-abbas.jpg",
    campus: "main",
    is_active: true,
    sort_order: 7,
    created_at: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    name: "Abbas Malik",
    subject: "Computer",
    designation: "Lecturer Al-Kausar",
    initials: "AM",
    campus: "main",
    is_active: true,
    sort_order: 10,
  ...
  },
  {
    ...
    name: "Zaheer Malik",
    subject: "Accounting",
    designation: "Account Officer PAF",
    initials: "ZM",
    campus: "second",
    is_active: false,
    sort_order: 11,
    ...
    queryFn: async (): Promise<Faculty[]> => {
      if (USE_MOCK) {
        ...
        if (filters?.isActive !== undefined)
          result = result.filter((f) => f.is_active === filters.isActive);
