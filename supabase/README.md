...
The local pgTAP test suite now contains 28 assertions. Run `supabase test db` only in a disposable environment with Docker/Postgres available; do not apply these migrations to production as a substitute for the regression suite.
